...
import { updatePasswordAction } from "@/redux/slices/userSlice";
...
const formSchema = yup.object({
  oldPassword: yup
    ...
    .min(6, "Old password must at least 6 characters"),
  password: yup
    .string()
...
function UpdatePassword(props) {
  ...
  const { loading, appErr, serverErr, passwordUpdated } = userStore;
