...
import UploadProfilePhoto from "@/components/Modals/UploadProfilePhoto";

function ProfileNeedOptimize() {
  const { id } = useParams();
  ...
  const { profile, loading, appErr, serverErr } = userStore;

  let isPermission = false;
  if (profile) {
    isPermission = usePostPermission({ userId: profile?._id });
  }
  ...
  const handleUpdateProfilePhoto = (file) => {
    dispatch(uploadProfilePhotoAction(file));
  };
                ...
                <article>
                  ...
                  <div>
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                          <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                            ...
                            <p className="m-3 text-lg">
                              Date Joined: {dateFormatter(profile?.createdAt)}
                            </p>
                      ...
                      <div className="sm:block 2xl:hidden mt-6 min-w-0 flex-1">
...
export default ProfileNeedOptimize;
